...
def iniatialize():
    ...
    for obj_name in object_names:
        ...
        for ch_name in channel_names:
            ...
            all_copies_of_object.append(Channel_object(ch_name, SRC_ip_addr, SRC_port, SRC_username, SRC_userpass, OUT_ip_addr, OUT_port, OUT_username, OUT_userpass, SRC_node, SRC_database, SRC_measurement, model_name, model_dir, rate, OUT_node, OUT_database, OUT_measurement, ML_core_ip_addr, ML_core_port))
